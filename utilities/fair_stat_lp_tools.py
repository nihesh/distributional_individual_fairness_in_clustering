...
"""
This module contains necessary helper functions to build the Cplex lp in alg_cf.py
"""
...
def prepare_to_add_individual_fairness_constraints(dataset, centres, groups, P, C, eqn_id, n_neighbours, fairness_type):
